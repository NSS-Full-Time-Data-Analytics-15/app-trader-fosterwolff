...
SELECT ROUND(app_store_review_count::numeric*app_store_rating) AS app_store_weighted_rating,
ROUND(play_store_review_count::numeric*play_store_rating) AS play_store_weighted_rating,
*
FROM final_table
ORDER BY app_store_rating DESC, app_store_weighted_rating DESC, play_store_rating DESC, app_store_weighted_rating DESC
LIMIT 10;